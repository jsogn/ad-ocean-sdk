...
// 定向设置
class UniProjectListGetGetResponseListAudienceData extends Data
{
    ...
    /**
     * @var array<\AdOceanSdk\UNI\Data\UniProjectListGetGetResponseListAudienceGeolocationData> $geolocation 从地图添加(地图位置)
     */
