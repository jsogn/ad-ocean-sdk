...
// 产品信息
class UniProjectUpdatePostParamProductInfoData extends Data
{
    ...
    /**
     * @var array<string> $image_ids 全域中所关联的产品会在此参数中，绑定一个与产品相关主图，除了自动绑定的主图外，还需手动上传至少1个主图，上限为10个产品主图，尺寸要求108*108，上限10个
可通过【获取图片素材】接口获得
     */
