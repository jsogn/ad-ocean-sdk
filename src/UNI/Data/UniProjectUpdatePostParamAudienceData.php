...
// 定向设置
class UniProjectUpdatePostParamAudienceData extends Data
{
    ...
    /**
     * @var array<\AdOceanSdk\UNI\Data\UniProjectUpdatePostParamAudienceGeolocationData> $geolocation 从地图添加(地图位置)，district为"BUSINESS_DISTRICT"时填写，最多允许添加1000个
     */
    ...
    /**
     * @var string $location_type 位置类型，允许值： CURRENT正在该地区的用户HOME居住在该地区的用户TRAVEL到该地区旅行的用户ALL该地区内的所有用户
     */
    ...
    /**
     * @var array<string> $platform 允许值：ANDROID、IOS投放平台列表
     */
    public array $platform;

    /**
     * @var string $hide_if_converted 过滤已转化用户，可以避免该单元再次投放给已转化过的用户。
允许值：NO_EXCLUDE 不限制PROJECT 项目ADVERTISER 投放账户CUSTOMER 客户ORGANIZATION 组织
     */
    public string $hide_if_converted;

    /**
     * @var string $converted_time_duration 当 hide_if_converted =   CUSTOMER  公司帐户 或  ORGANIZATION  组织账户时传入有效过滤时间范围，详见 【附录-过滤时间范围】
     */
