...
// 商品库商品列表
class DpaEbpProductListGetResponseListData extends Data
{
    ...
    /**
     * @var int $audit_status 商品审核状态，枚举值：1代表审核通过，2代表审核拒绝，-1代表审核中
     */
    ...
    /**
     * @var array<\AdOceanSdk\DPA\Data\DpaEbpProductListGetResponseListVideosData> $videos 视频内容，小说库特有字段
     */
    public array $videos;

    /**
     * @var array<\AdOceanSdk\DPA\Data\DpaEbpProductListGetResponseListImageUrlsData> $image_urls 扩展商品图，商品图片的补充
     */
    public array $image_urls;

    /**
     * @var \AdOceanSdk\DPA\Data\DpaEbpProductListGetResponseListBrandInfoData $brand_info 品牌信息
     */
    public \AdOceanSdk\DPA\Data\DpaEbpProductListGetResponseListBrandInfoData $brand_info;

    /**
     * @var \AdOceanSdk\DPA\Data\DpaEbpProductListGetResponseListShopKeeperInfoData $shop_keeper_info 商户信息
     */
    public \AdOceanSdk\DPA\Data\DpaEbpProductListGetResponseListShopKeeperInfoData $shop_keeper_info;

    /**
     * @var \AdOceanSdk\DPA\Data\DpaEbpProductListGetResponseListLandingInfoData $landing_info 落地页信息
     */
    public \AdOceanSdk\DPA\Data\DpaEbpProductListGetResponseListLandingInfoData $landing_info;
    ...
    /**
     * @var \AdOceanSdk\DPA\Data\DpaEbpProductListGetResponseListPriceInfoData $price_info 价格信息
     */
    public \AdOceanSdk\DPA\Data\DpaEbpProductListGetResponseListPriceInfoData $price_info;
    ...
    /**
     * @var array<int> $age 年龄段，用于定向人群，默认不限，数组项允许值如下：
     */
    public array $age;

    /**
     * @var array $profession 行业信息
     */
