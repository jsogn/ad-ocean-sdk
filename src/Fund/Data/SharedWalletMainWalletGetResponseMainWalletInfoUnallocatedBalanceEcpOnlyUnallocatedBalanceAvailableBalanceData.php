...
// 可用余额(单位元)
class SharedWalletMainWalletGetResponseMainWalletInfoUnallocatedBalanceEcpOnlyUnallocatedBalanceAvailableBalanceData extends Data
{
    ...
    /**
     * @var float $credit_brand_balance 授信品牌可用余额(单位元)
     */
    public float $credit_brand_balance;
    
    /**
     * @var float $preloan_general_balance 预借款通用可用余额(单位元)
     */
    public float $preloan_general_balance;
    
    /**
     * @var float $preloan_bidding_balance 预借款竞价可用余额(单位元)
     */
    public float $preloan_bidding_balance;
    
    /**
     * @var float $preloan_brand_balance 预借款品牌可用余额(单位元)
     */
