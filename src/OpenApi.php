 ...
 * @method \AdOceanSdk\Advertising\Response\CreativeDetailGetResponse openAdvertiserCreativeDetailGetApi(\AdOceanSdk\Advertising\Params\CreativeDetailGetParams|array $params) 创意详细信息（新） https://open.oceanengine.com/labels/7/docs/1742668551117827
 * @method \AdOceanSdk\Advertising\Response\CreativeTemplateTagsGetResponse openAdvertiserCreativeTemplateTagsGetApi(\AdOceanSdk\Advertising\Params\CreativeTemplateTagsGetParams|array $params) 获取模板标签列表 https://open.oceanengine.com/labels/7/docs/1736241004382219
 * @method \AdOceanSdk\Advertising\Response\CreativeMaterialMetricsGetResponse openAdvertiserCreativeMaterialMetricsGetApi(\AdOceanSdk\Advertising\Params\CreativeMaterialMetricsGetParams|array $params) 获取素材派生数据（素材维度） https://open.oceanengine.com/labels/7/docs/1755177023094787
 * @method \AdOceanSdk\Advertising\Response\CreativeUpdateStatusPostResponse openAdvertiserCreativeUpdateStatusPostApi(\AdOceanSdk\Advertising\Params\CreativeUpdateStatusPostParams|array $params) 更改创意状态 https://open.oceanengine.com/labels/7/docs/1696710543049740
 ...
 * @method \AdOceanSdk\Advertising\Response\CreativeAutoGenerateConfigCreatePostResponse openAdvertiserCreativeAutoGenerateConfigCreatePostApi(\AdOceanSdk\Advertising\Params\CreativeAutoGenerateConfigCreatePostParams|array $params) 新建或修改配置，并保存到计划 https://open.oceanengine.com/labels/7/docs/1736244450483215
 * @method \AdOceanSdk\Advertising\Response\CreativeGetResponse openAdvertiserCreativeGetApi(\AdOceanSdk\Advertising\Params\CreativeGetParams|array $params) 获取创意列表 https://open.oceanengine.com/labels/7/docs/1696710540735500
 * @method \AdOceanSdk\Advertising\Response\CampaignGetResponse openAdvertiserCampaignGetApi(\AdOceanSdk\Advertising\Params\CampaignGetParams|array $params) 获取广告组 https://open.oceanengine.com/labels/7/docs/1696710532657164
 * @method \AdOceanSdk\Advertising\Response\AdMetricsGetGetResponse openAdvertiserAdMetricsGetGetApi(\AdOceanSdk\Advertising\Params\AdMetricsGetGetParams|array $params) 获取素材派生数据（计划维度） https://open.oceanengine.com/labels/7/docs/1755177028152324
 * @method \AdOceanSdk\Advertising\Response\CreativeTemplateDetailGetGetResponse openAdvertiserCreativeTemplateDetailGetGetApi(\AdOceanSdk\Advertising\Params\CreativeTemplateDetailGetGetParams|array $params) 获取模板详情 https://open.oceanengine.com/labels/7/docs/1736243716320256
 * @method \AdOceanSdk\Advertising\Response\CreativeTemplateListGetResponse openAdvertiserCreativeTemplateListGetApi(\AdOceanSdk\Advertising\Params\CreativeTemplateListGetParams|array $params) 获取模板列表 https://open.oceanengine.com/labels/7/docs/1736241054353421
