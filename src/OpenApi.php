 ...
 * @method \AdOceanSdk\Advertising\Response\AdvertiserCreativeGetResponse openAdvertiserCreativeGetGetApi(\AdOceanSdk\Advertising\Params\AdvertiserCreativeGetParams|array $params) 获取创意列表 https://open.oceanengine.com/labels/7/docs/1696710540735500
