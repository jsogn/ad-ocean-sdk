 ...
 * @method \AdOceanSdk\Advertising\Response\AdvertiserCreativeDetailGetResponse openAdvertiserCreativeDetailGetApi(\AdOceanSdk\Advertising\Params\AdvertiserCreativeDetailGetParams|array $params) 创意详细信息（新） https://open.oceanengine.com/labels/7/docs/1742668551117827
 ...
 * @method \AdOceanSdk\Advertising\Response\AdvertiserCreativeMaterialMetricsGetResponse openAdvertiserCreativeMaterialMetricsGetApi(\AdOceanSdk\Advertising\Params\AdvertiserCreativeMaterialMetricsGetParams|array $params) 获取素材派生数据（素材维度） https://open.oceanengine.com/labels/7/docs/1755177023094787
 * @method \AdOceanSdk\Advertising\Response\AdvertiserCreativeUpdateStatusPostResponse openAdvertiserCreativeUpdateStatusPostApi(\AdOceanSdk\Advertising\Params\AdvertiserCreativeUpdateStatusPostParams|array $params) 更新创意状态 https://open.oceanengine.com/labels/7/docs/1700170319321092
 ...
 * @method \AdOceanSdk\Advertising\Response\AdvertiserCreativeAutoGenerateConfigCreatePostResponse openAdvertiserCreativeAutoGenerateConfigCreatePostApi(\AdOceanSdk\Advertising\Params\AdvertiserCreativeAutoGenerateConfigCreatePostParams|array $params) 新建或修改配置，并保存到计划 https://open.oceanengine.com/labels/7/docs/1736244450483215
 ...
 * @method \AdOceanSdk\Advertising\Response\AdvertiserAdMetricsGetGetResponse openAdvertiserAdMetricsGetGetApi(\AdOceanSdk\Advertising\Params\AdvertiserAdMetricsGetGetParams|array $params) 获取素材派生数据（计划维度） https://open.oceanengine.com/labels/7/docs/1755177028152324
 * @method \AdOceanSdk\Advertising\Response\AdvertiserCreativeTemplateDetailGetGetResponse openAdvertiserCreativeTemplateDetailGetGetApi(\AdOceanSdk\Advertising\Params\AdvertiserCreativeTemplateDetailGetGetParams|array $params) 获取模板详情 https://open.oceanengine.com/labels/7/docs/1736243716320256
