...
class AudiencePackageCreatePostParams extends RequestParams
{
    ...
    /**
     * @var string $android_osv 受众最低android版本(当推广应用下载Android时选填,其余情况不填), 详见【附录-受众android版本】允许值: "0.0", "2.0", "2.1", "2.2", "2.3", "3.0", "3.1", "3.2", "4.0","4.1","4.2", "4.3", "4.4", "4.5", "5.0", "NONE"
     */
    public string $android_osv;
    
    /**
     * @var string $ios_osv 受众最低ios版本(当推广应用下载iOS时选填,其余情况不填), 详见【附录-受众ios版本】允许值: "0.0", "4.0", "4.1", "4.2", "4.3", "5.0", "5.1", "6.0", "7.0","7.1","8.0", "8.1", "8.2", "9.0", "NONE"
     */
