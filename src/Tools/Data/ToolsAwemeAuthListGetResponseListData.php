...
class ToolsAwemeAuthListGetResponseListData extends Data
{
    ...
    /**
     * @var \AdOceanSdk\Tools\Data\ToolsAwemeAuthListGetResponseListVideoInfoData|null $video_info 授权视频信息，若为单视频授权会返回
     */
    public ?\AdOceanSdk\Tools\Data\ToolsAwemeAuthListGetResponseListVideoInfoData $video_info = null;
