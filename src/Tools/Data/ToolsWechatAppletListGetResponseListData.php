...
// 微信小程序列表
class ToolsWechatAppletListGetResponseListData extends Data
{
    ...
    /**
     * @var array<string> $images_vertical_url 小程序竖图的url
     */
    public array $images_vertical_url;
    
    /**
     * @var array<string> $images_horizontal_url 小程序横图的url
     */
