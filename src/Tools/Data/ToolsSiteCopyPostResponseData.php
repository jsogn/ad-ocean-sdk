...
class ToolsSiteCopyPostResponseData extends Data
{
    ...
    /**
     * @var \AdOceanSdk\Tools\Data\ToolsSiteCopyPostResponseSuccessListData $success_list 复制成功列表，整体失败不返回该列表
     */
    public \AdOceanSdk\Tools\Data\ToolsSiteCopyPostResponseSuccessListData $success_list;
