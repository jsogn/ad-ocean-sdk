...
return [
    ...
    **/
    'openDpaEbpClueProductGetGetApi' => [
        'desc' => '获取升级版商品详情',
        'doc' => 'https://open.oceanengine.com/labels/7/docs/1846200329551114?origin=left_nav',
        'call' => AdOceanSdk\DPA\Api\DpaEbpClueProductGetGetApi::class,
        'params' => AdOceanSdk\DPA\Params\DpaEbpClueProductGetGetParams::class,
        'response' => AdOceanSdk\DPA\Response\DpaEbpClueProductGetGetResponse::class,
    ],
    /**
    * @desc 获取升级版商品列表
    * @doc  https://open.oceanengine.com/labels/7/docs/1846200582278283?origin=left_nav
    **/
    'openDpaEbpClueProductListGetApi' => [
        'desc' => '获取升级版商品列表',
        'doc' => 'https://open.oceanengine.com/labels/7/docs/1846200582278283?origin=left_nav',
        'call' => AdOceanSdk\DPA\Api\DpaEbpClueProductListGetApi::class,
        'params' => AdOceanSdk\DPA\Params\DpaEbpClueProductListGetParams::class,
    ...
    **/
    'openDpaEbpClueProductSavePostApi' => [
        'desc' => '升级版组织-创建/编辑升级版商品',
        'doc' => 'https://open.oceanengine.com/labels/7/docs/1846200828633995?origin=left_nav',
        'call' => AdOceanSdk\DPA\Api\DpaEbpClueProductSavePostApi::class,
        'params' => AdOceanSdk\DPA\Params\DpaEbpClueProductSavePostParams::class,
        'response' => AdOceanSdk\DPA\Response\DpaEbpClueProductSavePostResponse::class,
    ],
    /**
    * @desc 获取商品库DPA词包
    ...
    **/
    'openDpaEbpLibraryListGetApi' => [
        'desc' => '获取商品库列表',
        'doc' => 'https://open.oceanengine.com/labels/7/docs/1846200555058186?origin=left_nav',
        'call' => AdOceanSdk\DPA\Api\DpaEbpLibraryListGetApi::class,
        'params' => AdOceanSdk\DPA\Params\DpaEbpLibraryListGetParams::class,
        'response' => AdOceanSdk\DPA\Response\DpaEbpLibraryListGetResponse::class,
    ],
    /**
    * @desc 查询短剧商品原片授权申请状态
    ...
    **/
    'openDpaEbpProductDetailGetGetApi' => [
        'desc' => '获取通用版商品详情',
        'doc' => 'https://open.oceanengine.com/labels/7/docs/1846200441152906?origin=left_nav',
        'call' => AdOceanSdk\DPA\Api\DpaEbpProductDetailGetGetApi::class,
        'params' => AdOceanSdk\DPA\Params\DpaEbpProductDetailGetGetParams::class,
        'response' => AdOceanSdk\DPA\Response\DpaEbpProductDetailGetGetResponse::class,
    ],
    /**
    * @desc 获取通用版商品列表
    ...
    **/
    'openDpaEbpProductStatusBatchUpdatePostApi' => [
        'desc' => '批量修改DPA商品状态',
        'doc' => 'https://open.oceanengine.com/labels/7/docs/1846200705851659?origin=left_nav',
        'call' => AdOceanSdk\DPA\Api\DpaEbpProductStatusBatchUpdatePostApi::class,
        'params' => AdOceanSdk\DPA\Params\DpaEbpProductStatusBatchUpdatePostParams::class,
    ...
    **/
    'openDpaEbpProductUpdatePostApi' => [
        'desc' => '升级版组织-编辑通用版商品',
        'doc' => 'https://open.oceanengine.com/labels/7/docs/1846200800780617?origin=left_nav',
        'call' => AdOceanSdk\DPA\Api\DpaEbpProductUpdatePostApi::class,
        'params' => AdOceanSdk\DPA\Params\DpaEbpProductUpdatePostParams::class,
    ...
    **/
    'openOcProjectMaterialStatusUpdatePostApi' => [
        'desc' => '批量修改投放项目下素材状态',
        'doc' => 'https://open.oceanengine.com/labels/7/docs/1854930119140363',
        'call' => AdOceanSdk\UNI\Api\OcProjectMaterialStatusUpdatePostApi::class,
        'params' => AdOceanSdk\UNI\Params\OcProjectMaterialStatusUpdatePostParams::class,
        'response' => AdOceanSdk\UNI\Response\OcProjectMaterialStatusUpdatePostResponse::class,
    ],
    /**
    * @desc 批量更新项目预算
    ...
    **/
    'openProjectCpaBidUpdatePostApi' => [
        'desc' => '批量更新项目出价NEW',
        'doc' => 'https://open.oceanengine.com/labels/34/docs/1858174581876745?origin=left_nav',
        'call' => AdOceanSdk\Advertising\Api\ProjectCpaBidUpdatePostApi::class,
        'params' => AdOceanSdk\Advertising\Params\ProjectCpaBidUpdatePostParams::class,
        'response' => AdOceanSdk\Advertising\Response\ProjectCpaBidUpdatePostResponse::class,
    ],
    /**
    * @desc 创建项目
    ...
    **/
    'openProjectRejectReasonGetApi' => [
        'desc' => '获取投放项目审核建议',
        'doc' => 'https://open.oceanengine.com/labels/7/docs/1854930234989579',
        'call' => AdOceanSdk\OcProject\Api\ProjectRejectReasonGetApi::class,
        'params' => AdOceanSdk\OcProject\Params\ProjectRejectReasonGetParams::class,
        'response' => AdOceanSdk\OcProject\Response\ProjectRejectReasonGetResponse::class,
    ],
    /**
    * @desc 批量修改项目ROI系数
    ...
    **/
    'openUniProjectAwemeAuthorizedGetApi' => [
        'desc' => '获取全域创编可用抖音号',
        'doc' => 'https://open.oceanengine.com/labels/7/docs/1854930373174281',
        'call' => AdOceanSdk\UNI\Api\UniProjectAwemeAuthorizedGetApi::class,
        'params' => AdOceanSdk\UNI\Params\UniProjectAwemeAuthorizedGetParams::class,
        'response' => AdOceanSdk\UNI\Response\UniProjectAwemeAuthorizedGetResponse::class,
    ],
    /**
    * @desc 新建全域投放项目
    ...
    **/
    'openUniProjectCreatePostApi' => [
        'desc' => '新建全域投放项目',
        'doc' => 'https://open.oceanengine.com/labels/7/docs/1854206019149016',
        'call' => AdOceanSdk\UNI\Api\UniProjectCreatePostApi::class,
        'params' => AdOceanSdk\UNI\Params\UniProjectCreatePostParams::class,
        'response' => AdOceanSdk\UNI\Response\UniProjectCreatePostResponse::class,
    ],
    /**
    * @desc 获取全域投放项目列表
    ...
    **/
    'openUniProjectListGetApi' => [
        'desc' => '获取全域投放项目列表',
        'doc' => 'https://open.oceanengine.com/labels/7/docs/1854926110406984',
        'call' => AdOceanSdk\UNI\Api\UniProjectListGetApi::class,
        'params' => AdOceanSdk\UNI\Params\UniProjectListGetParams::class,
        'response' => AdOceanSdk\UNI\Response\UniProjectListGetResponse::class,
    ],
    /**
    * @desc 获取全域投放项目列表
    * @doc  https://open.oceanengine.com/labels/7/docs/1854926110406984
    ...
    **/
    'openUniProjectUpdatePostApi' => [
        'desc' => '编辑全域投放项目',
        'doc' => 'https://open.oceanengine.com/labels/7/docs/1854910852321354',
        'call' => AdOceanSdk\UNI\Api\UniProjectUpdatePostApi::class,
        'params' => AdOceanSdk\UNI\Params\UniProjectUpdatePostParams::class,
        'response' => AdOceanSdk\UNI\Response\UniProjectUpdatePostResponse::class,
    ],
    /**
    * @desc 获取微信小程序列表
    * @doc  https://open.oceanengine.com/labels/7/docs/1771203622020111
