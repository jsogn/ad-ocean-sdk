...
class CreativeGetParams extends RequestParams
{
    ...
    /**
     * @var \AdOceanSdk\Advertising\Data\CreativeGetParamFilteringData $filtering 过滤条件，若此字段不传，或传空则视为无限制条件
     */
    public \AdOceanSdk\Advertising\Data\CreativeGetParamFilteringData $filtering;
